...
// action function
func (oc *OpenstackClient) ListComputeV2ExtensionsTenantnetworks(request *ListComputeV2ExtensionsTenantnetworksRequest)(*ListComputeV2ExtensionsTenantnetworksResponse){
...
// action function
func (oc *OpenstackClient) GetComputeV2ExtensionsTenantnetworks(request *GetComputeV2ExtensionsTenantnetworksRequest)(*GetComputeV2ExtensionsTenantnetworksResponse){
    return NewGetComputeV2ExtensionsTenantnetworksResponse(tenantnetworks.Get(oc.client,request.Id, ))
